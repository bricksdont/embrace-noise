...
sbatch --qos=vesta --time=1:00:00 --gres gpu:Tesla-V100:1 --cpus-per-task 3 --mem 48g $base/scripts/translations/translate_generic.sh $base $data_sub $translations_sub $model_path
